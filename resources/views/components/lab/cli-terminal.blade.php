<div class="flex flex-col flex-1 overflow-hidden" style="background:#0a0a0a; min-height:420px;"
    ...
    <div class="flex items-center justify-between border-t border-slate-800 px-4 py-2 text-xs"
        ...
        <span class="text-slate-600 space-x-2">
            <kbd class="rounded bg-slate-800 px-1 py-0.5 text-slate-400 font-mono">?</kbd><span class="text-slate-700">help</span>
            <kbd class="rounded bg-slate-800 px-1 py-0.5 text-slate-400 font-mono">Tab</kbd><span class="text-slate-700">complete</span>
            <kbd class="rounded bg-slate-800 px-1 py-0.5 text-slate-400 font-mono">↑↓</kbd><span class="text-slate-700">history</span>
            <kbd class="rounded bg-slate-800 px-1 py-0.5 text-slate-400 font-mono">Ctrl+C</kbd><span class="text-slate-700">break</span>
        </span>
