<svg class="hidden" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
    <defs>
        ...
        <linearGradient id="grad-pc" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stop-color="#33547c"/>
        ...
        <linearGradient id="grad-cloud" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stop-color="#4a4870"/>
        ...
        <symbol id="dev-router" viewBox="0 0 64 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <polygon points="46,18 56,11 56,29 46,36" fill="#0a4a82"/>
            {{-- Top face --}}
            <polygon points="10,18 46,18 56,11 20,11" fill="#2b8cd6"/>
            {{-- Front face --}}
            <rect x="10" y="18" width="36" height="18" fill="#0d5fa6"/>
            {{-- Edge highlights --}}
            <line x1="10" y1="18" x2="46" y2="18" stroke="#4aa8e8" stroke-width="0.7"/>
            <polyline points="10,18 20,11 56,11 46,18" stroke="#4aa8e8" stroke-width="0.7" fill="none"/>
            <polyline points="46,18 56,11 56,29 46,36" stroke="#0d6aaf" stroke-width="0.7" fill="none"/>
            {{-- Ports --}}
            <rect x="14" y="22" width="4.5" height="3" rx="0.6" fill="#041e3d"/>
            <rect x="21" y="22" width="4.5" height="3" rx="0.6" fill="#041e3d"/>
            <rect x="28" y="22" width="4.5" height="3" rx="0.6" fill="#041e3d"/>
            <rect x="35" y="22" width="4.5" height="3" rx="0.6" fill="#041e3d"/>
            {{-- Status LEDs --}}
            <circle cx="14" cy="31" r="1.5" fill="#22c55e"/>
            <circle cx="18" cy="31" r="1.5" fill="#22c55e"/>
            <circle cx="22" cy="31" r="1.5" fill="#f59e0b"/>
            {{-- Cisco branding --}}
            <line x1="39" y1="23" x2="44" y2="23" stroke="#1a7bc4" stroke-width="0.9"/>
            <line x1="39" y1="25" x2="44" y2="25" stroke="#1a7bc4" stroke-width="0.9"/>
            <line x1="39" y1="27" x2="44" y2="27" stroke="#1a7bc4" stroke-width="0.9"/>
            {{-- Vents on right face --}}
            <line x1="48" y1="15" x2="54" y2="15" stroke="#0d6aaf" stroke-width="0.7"/>
            <line x1="48" y1="18" x2="54" y2="18" stroke="#0d6aaf" stroke-width="0.7"/>
            <line x1="48" y1="21" x2="54" y2="21" stroke="#0d6aaf" stroke-width="0.7"/>
        </symbol>
        ...
        <symbol id="dev-switch" viewBox="0 0 64 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {{-- Right face --}}
            <polygon points="52,14 62,8 62,26 52,32" fill="#1f2f44"/>
            {{-- Top face --}}
            <polygon points="4,14 52,14 62,8 14,8" fill="#5b7ea0"/>
            {{-- Front face --}}
            <rect x="4" y="14" width="48" height="18" rx="1.5" fill="url(#grad-switch)"/>
            {{-- Top sheen --}}
            <rect x="4" y="14" width="48" height="2.2" rx="1" fill="#7aa2c8" fill-opacity="0.35"/>
            {{-- Port row 1 --}}
            <rect x="8"  y="18" width="4.5" height="3.5" rx="0.5" fill="#071526" stroke="#1e3a5f" stroke-width="0.4"/>
            <rect x="15" y="18" width="4.5" height="3.5" rx="0.5" fill="#071526" stroke="#1e3a5f" stroke-width="0.4"/>
            <rect x="22" y="18" width="4.5" height="3.5" rx="0.5" fill="#071526" stroke="#1e3a5f" stroke-width="0.4"/>
            <rect x="29" y="18" width="4.5" height="3.5" rx="0.5" fill="#071526" stroke="#1e3a5f" stroke-width="0.4"/>
            <rect x="36" y="18" width="4.5" height="3.5" rx="0.5" fill="#071526" stroke="#1e3a5f" stroke-width="0.4"/>
            <rect x="43" y="18" width="4.5" height="3.5" rx="0.5" fill="#071526" stroke="#1e3a5f" stroke-width="0.4"/>
            {{-- Port row 2 --}}
            <rect x="8"  y="23.5" width="4.5" height="3.5" rx="0.5" fill="#071526" stroke="#1e3a5f" stroke-width="0.4"/>
            <rect x="15" y="23.5" width="4.5" height="3.5" rx="0.5" fill="#071526" stroke="#1e3a5f" stroke-width="0.4"/>
            <rect x="22" y="23.5" width="4.5" height="3.5" rx="0.5" fill="#071526" stroke="#1e3a5f" stroke-width="0.4"/>
            <rect x="29" y="23.5" width="4.5" height="3.5" rx="0.5" fill="#071526" stroke="#1e3a5f" stroke-width="0.4"/>
            <rect x="36" y="23.5" width="4.5" height="3.5" rx="0.5" fill="#071526" stroke="#1e3a5f" stroke-width="0.4"/>
            <rect x="43" y="23.5" width="4.5" height="3.5" rx="0.5" fill="#071526" stroke="#1e3a5f" stroke-width="0.4"/>
            {{-- Status LEDs --}}
            ...
            {{-- Bottom vents --}}
            <rect x="4" y="27" width="48" height="4.4" rx="1" fill="#071526" fill-opacity="0.45"/>
        </symbol>
        ...
        <symbol id="dev-pc" viewBox="0 0 64 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {{-- Monitor top face --}}
            <polygon points="8,7 48,7 54,3 14,3" fill="#4a6f9e"/>
            {{-- Monitor right face --}}
            <polygon points="48,7 54,3 54,25 48,29" fill="#16233c"/>
            {{-- Monitor front --}}
            <rect x="8" y="7" width="40" height="22" rx="1.5" fill="url(#grad-pc)"/>
            {{-- Screen --}}
            <rect x="12" y="10" width="32" height="16" rx="1" fill="#0a1628"/>
            <rect x="14" y="12" width="28" height="12" fill="#0d2040" fill-opacity="0.9"/>
            <line x1="16" y1="15" x2="36" y2="15" stroke="#38bdf8" stroke-width="0.9" stroke-opacity="0.6"/>
            <line x1="16" y1="18" x2="40" y2="18" stroke="#38bdf8" stroke-width="0.9" stroke-opacity="0.35"/>
            <line x1="16" y1="21" x2="38" y2="21" stroke="#38bdf8" stroke-width="0.9" stroke-opacity="0.3"/>
            {{-- Power LED --}}
            <circle cx="45" cy="25" r="1.3" fill="#22c55e"/>
            {{-- Stand neck --}}
            <rect x="26" y="29" width="4" height="7" fill="#1e3352"/>
            {{-- Base (isometric) --}}
            <polygon points="18,36 46,36 50,33 22,33" fill="#24446e"/>
            <polygon points="22,33 50,33 50,38 22,38" fill="#16233c"/>
            <rect x="18" y="36" width="28" height="4" rx="1.5" fill="#2e4a6e"/>
        </symbol>
        ...
        <symbol id="dev-server" viewBox="0 0 64 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <ellipse cx="32" cy="41" rx="24" ry="3.2" fill="#000000" opacity="0.18"/>
            {{-- Right face --}}
            <polygon points="52,12 62,6 62,28 52,34" fill="#17232f"/>
            {{-- Top face --}}
            <polygon points="4,12 52,12 62,6 14,6" fill="#3a4c60"/>
            {{-- Front face --}}
            <rect x="4" y="12" width="48" height="22" rx="1.5" fill="url(#grad-server)"/>
            <rect x="4" y="12" width="48" height="2.2" rx="1" fill="#4a6078" fill-opacity="0.4"/>
            {{-- Drive bays --}}
            <rect x="8"  y="17" width="16" height="6" rx="1" fill="#0f1a24" stroke="#2a3a4a" stroke-width="0.4"/>
            <rect x="27" y="17" width="16" height="6" rx="1" fill="#0f1a24" stroke="#2a3a4a" stroke-width="0.4"/>
            <circle cx="12" cy="20" r="1" fill="#22c55e"/>
            <circle cx="31" cy="20" r="1" fill="#22c55e"/>
            <rect x="8"  y="26" width="16" height="5" rx="1" fill="#0f1a24" stroke="#2a3a4a" stroke-width="0.4"/>
            <rect x="27" y="26" width="16" height="5" rx="1" fill="#0f1a24" stroke="#2a3a4a" stroke-width="0.4"/>
            ...
            <rect x="46" y="28" width="4.5" height="3" rx="0.6" fill="#0f1a24" stroke="#3a4a5a" stroke-width="0.4"/>
        </symbol>
        ...
        <symbol id="dev-cloud" viewBox="0 0 64 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M20 36a10 10 0 0 1-2-19.8A13 13 0 0 1 43 18a9 9 0 0 1 4 17z"
                  fill="url(#grad-cloud)" stroke="#5a5880" stroke-width="0.6"/>
            <path d="M22 30a7 7 0 0 1-1-13.8A10 10 0 0 1 39 18a6 6 0 0 1 3 12z"
                  fill="#57558a" fill-opacity="0.35"/>
            <circle cx="20" cy="27" r="1.2" fill="#8a88c0" fill-opacity="0.5"/>
            <circle cx="28" cy="23" r="1.4" fill="#8a88c0" fill-opacity="0.4"/>
            <circle cx="38" cy="24" r="1.3" fill="#8a88c0" fill-opacity="0.4"/>
